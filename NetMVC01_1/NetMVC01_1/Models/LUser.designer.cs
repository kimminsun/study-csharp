...
namespace NetMVC01_1.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Mirim2017")]
    ...
    partial void DeleteTUser3102(TUser3102 instance);
		...
		public LUserDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["Mirim2017ConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<TUser3102> TUser3102
		{
			get
			{
				return this.GetTable<TUser3102>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TUser3102")]
	public partial class TUser3102 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnbSubcriptionChanging(int value);
    partial void OnbSubcriptionChanged();
    ...
    partial void OntheDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_bSubcription", DbType="Int NOT NULL")]
		public int bSubcription
		{
			get
			{
				return this._bSubcription;
			}
			set
			{
				if ((this._bSubcription != value))
				{
					this.OnbSubcriptionChanging(value);
					this.SendPropertyChanging();
					this._bSubcription = value;
					this.SendPropertyChanged("bSubcription");
					this.OnbSubcriptionChanged();
				}
			}
		}
